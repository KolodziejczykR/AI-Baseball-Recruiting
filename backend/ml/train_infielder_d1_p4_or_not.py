...
class InfielderD1P4ModelTrainer:
    ...
    def save_models(self, output_dir='../ml/models/'):
        ...
        for model_name, model in self.models.items():
            joblib.dump(model, f"{output_dir}/xgb_infield_d1_p4_or_not.pkl")
        
        # Save preprocessing objects
        joblib.dump(self.scalers, f"{output_dir}/scalers_infield_d1_p4.pkl")
        joblib.dump(self.label_encoders, f"{output_dir}/label_encoders_infield_d1_p4.pkl")
        
        print(f"Models saved to {output_dir}")

def main():
    """Main training function"""
    print("Starting Infielder D1 Power 4 vs Non-Power 4 Model Training...")
    
    # Initialize trainer
    trainer = InfielderD1P4ModelTrainer()
